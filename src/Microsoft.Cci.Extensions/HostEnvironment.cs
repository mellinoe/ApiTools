...
namespace Microsoft.Cci.Extensions
{
    ...
    public class HostEnvironment : MetadataReaderHost
    {
        ...
        {
            this._reader = new PeReader(this);
        ...
        {
            IUnit unit = this._reader.OpenModule(
        ...
        public IUnit LoadUnitFrom(string location, Stream stream)
        {
            ...
            IModule unit = this._reader.OpenModule(document);
        ...
        public IAssembly LoadAssembly(string assemblyNameOrPath)
        {
            ...
            foreach (var extension in _probingExtensions)
            {
        ...
        //   .ver 255:255:255:255
        // }
        private static readonly byte[] _ecmaKey = { 0xb7, 0x7a, 0x5c, 0x56, 0x19, 0x34, 0xe0, 0x89 };
        private static readonly Version _winmdBclVersion = new Version(255, 255, 255, 255);
        public bool ShouldUnifyToCoreAssembly(AssemblyIdentity assemblyIdentity)
        {
            ...
            {
                if (assemblyIdentity.PublicKeyToken == null || !assemblyIdentity.PublicKeyToken.SequenceEqual(_ecmaKey))
                    return false;
                if (!(assemblyIdentity.Version.Equals(_winmdBclVersion)))
                    return false;
